...
public class CampoCnpj extends CampoForm<String> {
    ...
    private boolean validateCnpj = true;
    
    /**
     * Construtor com label padrão "CNPJ".
     */
    public CampoCnpj() {
        this("CNPJ");
    }
    ...
    public CampoCnpj setValidateCnpj(boolean validate) {
        this.validateCnpj = validate;
        return this;
    }
    ...
    public CampoCnpj setRequired(boolean required) {
